...
const file_proto_driver_proto_rawDesc = "" +
	"\n" +
	"\x12proto/driver.proto\x12\x06driver\"k\n" +
	...
	"\tlongitude\x18\x02 \x01(\x01R\tlongitude2\xc1\x03\n" +
	"\rDriverService\x12I\n" +
	"\fCreateDriver\x12\x1b.driver.CreateDriverRequest\x1a\x1c.driver.CreateDriverResponse\x12@\n" +
	"\tGetDriver\x12\x18.driver.GetDriverRequest\x1a\x19.driver.GetDriverResponse\x12@\n" +
...
var file_proto_driver_proto_goTypes = []any{
	...
	(*GetDriverRequest)(nil),       // 2: driver.GetDriverRequest
	(*GetDriverResponse)(nil),      // 3: driver.GetDriverResponse
	(*CreateCarRequest)(nil),       // 4: driver.CreateCarRequest
	(*CreateCarResponse)(nil),      // 5: driver.CreateCarResponse
	(*ListCarsRequest)(nil),        // 6: driver.ListCarsRequest
	(*ListCarsResponse)(nil),       // 7: driver.ListCarsResponse
	(*Car)(nil),                    // 8: driver.Car
	(*RegisterDriverRequest)(nil),  // 9: driver.RegisterDriverRequest
	(*RegisterDriverResponse)(nil), // 10: driver.RegisterDriverResponse
	(*Driver)(nil),                 // 11: driver.Driver
	(*Location)(nil),               // 12: driver.Location
}
var file_proto_driver_proto_depIdxs = []int32{
	11, // 0: driver.CreateDriverResponse.driver:type_name -> driver.Driver
	11, // 1: driver.GetDriverResponse.driver:type_name -> driver.Driver
	8,  // 2: driver.CreateCarResponse.car:type_name -> driver.Car
	8,  // 3: driver.ListCarsResponse.cars:type_name -> driver.Car
	11, // 4: driver.RegisterDriverResponse.driver:type_name -> driver.Driver
	12, // 5: driver.Driver.location:type_name -> driver.Location
	0,  // 6: driver.DriverService.CreateDriver:input_type -> driver.CreateDriverRequest
	2,  // 7: driver.DriverService.GetDriver:input_type -> driver.GetDriverRequest
	4,  // 8: driver.DriverService.CreateCar:input_type -> driver.CreateCarRequest
	6,  // 9: driver.DriverService.ListCars:input_type -> driver.ListCarsRequest
	9,  // 10: driver.DriverService.RegisterDriver:input_type -> driver.RegisterDriverRequest
	9,  // 11: driver.DriverService.UnRegisterDriver:input_type -> driver.RegisterDriverRequest
	1,  // 12: driver.DriverService.CreateDriver:output_type -> driver.CreateDriverResponse
	3,  // 13: driver.DriverService.GetDriver:output_type -> driver.GetDriverResponse
	5,  // 14: driver.DriverService.CreateCar:output_type -> driver.CreateCarResponse
	7,  // 15: driver.DriverService.ListCars:output_type -> driver.ListCarsResponse
	10, // 16: driver.DriverService.RegisterDriver:output_type -> driver.RegisterDriverResponse
	10, // 17: driver.DriverService.UnRegisterDriver:output_type -> driver.RegisterDriverResponse
