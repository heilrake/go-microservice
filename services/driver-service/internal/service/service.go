...
func (s *driverService) CreateDriver(ctx context.Context, userID, name, profilePicture string) (*domain.Driver, error) {
	return s.repo.CreateDriver(ctx, userID, name, profilePicture)
}

func (s *driverService) GetDriver(ctx context.Context, userID string) (*domain.Driver, error) {
	return s.repo.GetByUserID(ctx, userID)
}

func (s *driverService) CreateCar(ctx context.Context, userID, carPlate, packageSlug string) (*domain.Car, error) {
...
func (s *driverService) ListCars(ctx context.Context, userID string) ([]*domain.Car, error) {
	driver, err := s.repo.GetByUserID(ctx, userID)
	if err != nil {
...
func (s *driverService) RegisterDriver(ctx context.Context, userID, carID string, lat, lon float64) (*domain.Driver, error) {
...
func (s *driverService) FindAvailableDrivers(ctx context.Context, packageType string) ([]*domain.Driver, error) {
